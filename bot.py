...
def message_handler(update: Update, context: CallbackContext):
    ...
    if 'Понеділок (т. 1)' in update.message.text:
        ...
        context.bot.send_message(chat_id=update.effective_chat.id, text=message, reply_markup = ReplyKeyboardMarkup(week_1_buttons), parse_mode=telegram.ParseMode.HTML)
